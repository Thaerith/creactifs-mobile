...
package creactifs.communication_http.composeapp.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/creactifs.communication_http.composeapp.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/creactifs.communication_http.composeapp.generated.resources/" +
      path)
